...
class ProductReservation(object):
	...
	def getProductReservation(self,productReservationId, responseFields = None):
		"""
			...
			Request Params
				int productReservationId Unique identifier of the product reservation.
				string responseFields Use this field to include those fields which are not included by default.
			Response
				ProductReservation 
		"""
	...
	def addProductReservations(self,productReservations, skipInventoryCheck = False):
		"""
			...
			Request Params
				...
				array|productReservations A hold placed on product inventory for a particular product so that the quantity specified is set aside and available for purchase during the ordering process.
			Response
