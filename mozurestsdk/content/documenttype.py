...
class DocumentType(object):
	...
	def getDocumentType(self,documentTypeName, responseFields = None):
		"""
			...
			Request Params
				string documentTypeName The name of the document type to retrieve.
				string responseFields Use this field to include those fields which are not included by default.
			Response
				DocumentType 
		"""
	...
	def createDocumentType(self,documentType, responseFields = None):
		"""
			...
			Request Params
				string responseFields Use this field to include those fields which are not included by default.
				documentType The type of documents used in the CMS such as "web_page" or "template" or "image_url".
			Response
				DocumentType 
		"""
